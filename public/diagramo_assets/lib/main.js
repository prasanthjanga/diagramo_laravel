...
DIAGRAMO.switchDebug = function(value) {
    ...
    if(DIAGRAMO.debug){
        iconDebug.src = '/diagramo_assets/assets/images/icon_debug_true.gif';
    }
    else{
        iconDebug.src = '/diagramo_assets/assets/images/icon_debug_false.gif';
    }
...
function setUploadedImagesList(){
    ...
    $.post(appURL+"/diagramo/controller",
    ...
    $.post( appURL+"/diagramo/controller",
        ...
        function(data){
            if(data === 'firstSave'){
                ...
                window.location = appURL+'/diagramo/save_diagram';                            
            }
            else if(data === 'saved'){
                //Log.info('saved!');
                alert('saved!');
...
function exportCanvas(){
    ...
    //see: http://api.jquery.com/jQuery.post/
    //"../common/controller.php"
    $.post(appURL+"/diagramo/controller", {action: 'saveSvg', svg: escape(v2)},
        function(data){
            if(data == 'svg_ok'){
...
function load(diagramId){
    ...
    // alert(diagramId);exit();
    //"./common/controller.php"
    $.post(appURL+"/diagramo/controller", {action: 'load', diagramId: diagramId},
        function(data){
                       // alert(data);exit();
            try{
                var obj  = eval('(' + data + ')');
...
// "./common/controller.php"
    $.post(appURL+"/diagramo/controller", {action: 'loadTemp', tempName: tempDiagramName},
        function(data){
//                        alert(data);
            try{
                var obj  = eval('(' + data + ')');
...
function loadQuickStartDiagram(){
    // "./common/controller.php"
    $.post(appURL+"/diagramo/controller", {action: 'loadQuickStart'},
        function(data){
//                        alert(data);
            try{
                var obj  = eval('(' + data + ')');
...
//   $serializedDiagram = JSON.stringify($diagram,  Util.operaReplacer);
   ...
   //see: http://api.jquery.com/jQuery.post/
   // "./common/controller.php"
   $.post(appURL+"/diagramo/controller", {action: 'saveAs', diagram: $serializedDiagram, png:dataURL, linkMap: lMap, svg: svgDiagram},
       function(data){
           if(data == 'noaccount'){
