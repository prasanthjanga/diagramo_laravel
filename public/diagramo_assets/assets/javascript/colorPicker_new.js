...
(function($){
  ...
  buildPicker = function(element){
    ...
    if($(element).val()==""){
        control.css("background-image","url(../diagramo_assets/assets/images/noColor.png)");
    }
    else {
    ...
    selector = $("<div id='color_selector'></div>");
     ...
     $.each($.fn.colorPicker.defaultColors, function(i){
      ...
      if(this[0] == 'n' && this[1] == '/' && this[2] == 'a' || this == "n/a"){//need both for all browser support
          swatch.css("background-image","url(../diagramo_assets/assets/images/noColor.png)");
  ...
  changeColor = function(value){
    if(selectedValue = toHex(value)){
      ...
      $(selectorOwner).css("background-image", "url(../diagramo_assets/assets/images/noColor.png)");
