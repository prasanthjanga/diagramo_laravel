...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="{{url('diagramo_assets')}}/favicon.ico" type="image/x-icon" />
        <link href="{{url('diagramo_assets')}}/assets/css/style.css" type="text/css" rel="stylesheet"/>
        ...
        <script type="text/javascript" src="{{url('diagramo_assets')}}/assets/javascript/dropdownmenu.js?<?=time()?>"></script>    
        <script type="text/javascript" src="{{url('diagramo_assets')}}/lib/browserReady.js?<?=time()?>"></script>
        <script type="text/javascript" src="{{url('diagramo_assets')}}/lib/log.js?<?=time()?>"></script>
    </head>
    <body>
        <div id="page">
            <? //require_once dirname(__FILE__) . '/header.php'; ?>
            @extends('diagramo::header')
            ...
            <div id="content" style="text-align: center;">
                ...
                <div class="form" style="width: 400px;">
                    ...
                    <form style="position: relative; height: 280px;" action="{{url('diagramo/controller')}}" method="post">
                        ...
                        <div style="position: absolute; top: 240px; left: 20px; right: 20px;">
                            <input onclick="return validateForm();" type="image" src="{{url('diagramo_assets')}}/assets/images/save.gif" style="display: block; margin-left: auto; margin-right: 0;" value="Save"/>
                        </div>
